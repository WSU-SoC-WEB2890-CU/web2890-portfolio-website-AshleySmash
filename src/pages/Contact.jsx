      ...
      <div className="contact-form">
        <div className="contact-box row container rounded bg-info py-5 px-4 my-4 mx-auto align-items-start">
          <div className="col-md-6 mb-4">
            ...
            <p>If you would like to know more, or have a question, feel free to contact me!</p>
            <p>
              You can use this messaging form or email me at <strong>ashleycox1@mail.weber.edu</strong>
            </p>
          ...
          <div className="col-md-6">
            <form id="form" onSubmit={handleSubmit} className="row g-3">
              ...
              <div className="col-12">
                <button type="submit" className="btn btn-teal text-white rounded p-2 w-100">
                  Submit
                </button>
              </div>
            </form>
            {isSubmitted && <p className="text-success mt-3">Thank you for your message! I'll get back to you soon.</p>}
          </div>
        </div>
      </div>
          ...
          <div className="accordion-item mx-3">
            ...
            >
              <div className="accordion-body">
                You can reach me via email or by filling out the contact form on this page.
              </div>
            </div>
          </div>
          <div className="accordion-item mx-3">
            ...
            <div
              ...
              data-bs-parent="#faqAccordion"
            >
              <div className="accordion-body">I aim to respond within 24-48 hours.</div>
            </div>
          </div>
        </div>
      </div>
